#+title: From Taking Apart Microwaves to Fixing a Thousand Phones and Motherboards: My Journey
#+date: <2024-03-19 Tue>
...
# TODO: add a collage of images
{{< figure
    src="reviews.jpg"
    alt="Microsoldering reviews Andres Navarro"
    caption="Sneak peek at some client reviews."
    >}}
...
{{< figure
    src="team_302_1.jpg"
    alt="Andres Navarro in the Robotics Team 302."
    caption="Check out the robot. We won the State Championship at the FIRST Competition :)"
    >}}
...
{{< figure
    src="laboratory.jpg"
    alt="Microsoldering laboratory"
    caption="Look at that microscope!"
    >}}
...
{{< figure
    src="iphone_7_cpu_swap.jpg"
    alt="iPhone 7 CPU swap"
    caption="My first iPhone 7 CPU swap."
    >}}
...
Check out my post!
{{< /badge >}}
<a href="/posts/aws/how_i_passed_the_aws_solutions_architect_professional_with_no_experience/">How I passed the AWS Solutions Architect Professional with no experience.</a>!
#+end_export
{{< /alert >}}
...
{{< figure
    src="cpu_swap.jpg"
    alt="CPU swap of an iPhone X."
    caption="CPU swap of an iPhone X submerged in gasoline."
    >}}
