...
{{< figure
    src="leir.jpg"
    alt="Me at CERN, specifically at the LEIR accelerator"
    caption="Me at CERN, specifically at the LEIR accelerator"
    >}}
...
{{< figure
    src="globe.jpg"
    alt="CERN Globe of Science and Innovation"
    caption="CERN Globe of Science and Innovation"
    >}}
...
* About Me
As you can see in my [[/posts][other posts]], I’m a passionate electronics and computer science enthusiast with a deep interest in learning new fields.

If you want to find out more about me, you can check out [[https://www.linkedin.com/in/andresnav][my LinkedIn]].

{{< figure
    src="tunnel.jpg"
    alt="Part of the LHC tunnel"
    caption="Part of the LHC tunnel"
    >}}
...
During my internship, I'm working on a project that involves developing and optimizing data acquisition systems for one of the experiments at the LHC, specifically in a [[https://gitlab.cern.ch/gasteam/olefin/][library for researching gas detectors for the accelerator]].
...
{{< figure
    src="antimatter_factory.jpg"
    alt="GBAR experiment at the Antimatter Factory"
    caption="GBAR experiment at the Antimatter Factory"
    >}}
